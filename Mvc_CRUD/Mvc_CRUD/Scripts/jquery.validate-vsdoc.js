	...
	prototype: {
		...
		defaultShowErrors: function() {
			...
			if (this.settings.success) {
				for ( var ni = 0; this.successList[ni]; ni++ ) {
					this.showLabel( this.successList[ni] );
				}
			}
			if (this.settings.unhighlight) {
				for ( var li = 0, elements = this.validElements(); elements[li]; li++ ) {
					this.settings.unhighlight.call( this, elements[li], this.settings.errorClass, this.settings.validClass );
				}
			}
